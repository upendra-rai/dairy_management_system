                                          ...
                                          <div class="col-md-2 col-sm-12 col-xs-12" >
                                            <div class="input-daterange input-group" id="datepicker" style=" width:100%;">
                                                <div class="form-group" id="data_5" style=" height:28px;">
                                                  <input type="text" class="form-control" name="start2" placeholder="Start Date" value="Start Date" />
                                                </div>
                                            </div>
                                           </div>
                                            <div class="col-md-2 col-sm-12 col-xs-12" >
                                            <div class="input-daterange input-group" id="datepicker" style=" width:100%;">
                                                <div class="form-group" id="data_5" style=" height:28px;">
                                                  <input type="text" class="form-control" name="end2" placeholder="End Date" value="End Date" />
                                                </div>
                                            </div>
                                           </div>
                                          <div class="col-md-2 col-sm-12 col-xs-12" style="paddin:0px;">
                                               
                                                     <button type="button"  id="search_date_bt2" class="btn btn-primary" style="width:100%; background-color:#46c7fe; color:#ffffff; border: 1px solid #46c7fe; float:left;">Submit</button>
						...
						<div class="asset-inner">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true"  data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true"  data-cookie="true"
									...
									<tr>
									 ...
									 <tbody id="re_table">
                                     <?php  foreach($agent_recharge as $row){ ?>
                                       
                                         <tr class="click_tr2" data-team_id="<?php echo $row->user_id ; ?>" data-date="<?php echo date('Y-m-d', strtotime($row->recharge_date)); ?>">
                                             
                                             <td><?php echo date('d-M-y',strtotime($row->recharge_date)); ?></td>
                                             
                                             <td><span class="rs_span">&#8377 </span> <?php echo number_format($row->total_re_value); ?></td>
                                             <td><?php echo $row->count_re; ?></td>
