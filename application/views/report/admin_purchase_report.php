                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12" style="padding:0;">
                                     <div class="input-daterange input-group" id="datepicker" style=" width:100%;">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" >
                                         ...
                                         <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" >
                                           <div class="form-group">
                                             <select class="form-control" name="supplyer" style="width:100%;">
                                                   <option value="">All Dealers</option>
                                                   <?php foreach($select_all_supplyer as $row){ ?>
                                                     <option value="<?php echo $row->supplyer_id; ?>" <?php if(isset($return_supplyer)){ if($return_supplyer == $row->supplyer_id){ echo 'selected'; } } ?>><?php echo $row->supplyer_name; ?></option>
                                                   <?php } ?>
                                             </select>
                                           </div>
                ...
                <div class="row" id="print_area">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                            ...
                            <div style="padding-top:10px; font-size: 17px; color:#262d31;">
                                <p>Customer Monthly Purchase Report <button type="button" class="btn" id="print" style="position:absolute; right:220px; margin-top:-15px;">Print</button></p>
                            </div>
                            <div>
                               ...
                               <table id="table" data-toggle="table" data-show-columns="true" data-show-pagination-switch="true"  data-key-events="true" data-show-toggle="true"  data-cookie="true"
                                   ...
                                   <thead>
                                            ...
                                            <th>Dealer</th>
    							    	          ...
    							    	          <tbody id="tran_table">
                                  <?php $i = 1; $sum_total_purchase = 0; $sum_total_qty = 0; $sum_sold_price = 0; $sum_profit = 0; foreach(json_decode($purchase_report) as $row){ ?>
                                    <tr style="border:1px solid blue;">
                                          ...
                                          <td> <span  style="color:#46c7fe; font-weight:600;"><?php echo $row->purchase_unit; ?></span> <?php echo +$row->purchase_qty; $sum_total_qty += $row->purchase_qty; ?></td>
                                          <td><i class="fa fa-rupee" style="color:#46c7fe;"></i> <?php echo +$row->total_purchase_price; $sum_total_purchase += $row->total_purchase_price; ?></td>

                                          <td><i class="fa fa-rupee" style="color:#46c7fe;"></i> <?php echo +$row->sum_sold_price; $sum_sold_price += $row->sum_sold_price; ?>
                                          <td><i class="fa fa-rupee" style="color:#46c7fe;"></i> <?php $profit =  $row->sum_sold_price - $row->total_purchase_price; if($profit > 0){ echo +$profit; $sum_profit +=  $profit; }else{ echo 0; } ?>
                                  ...
                                  <?php } ?>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border:1px solid #dddddd;"></td>
                                                <td style="border:1px solid #dddddd;"></td>
                                                <td style="border:1px solid #dddddd;"><?php echo +$sum_total_qty; ?></td>
                                                <td style="border:1px solid #dddddd;"><i class="fa fa-rupee" style="color:#46c7fe;"></i> <?php echo +$sum_total_purchase; ?></td>

                                                <td style="border:1px solid #dddddd;"><i class="fa fa-rupee" style="color:#46c7fe;"></i> <?php echo +$sum_sold_price; ?></td>
                                                <td style="border:1px solid #dddddd;"><i class="fa fa-rupee" style="color:#46c7fe;"></i> <?php echo +$sum_profit; ?></td>
                                                <td style="border:1px solid #dddddd;"></td>
                                            </tr>
