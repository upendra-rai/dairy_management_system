			    ...
			    <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div id="myheadtitle" style="margin:0px; height:60px; border-bottom:none; padding-top:15px; font-size: 15.5px;">
                               Agent Transaction Report <span><i class="ion-android-arrow-dropright" style="color: #0099cc;"></i></span> <?php  if(isset($transaction[0]->transaction_date)){ echo date('d-M-y',strtotime($transaction[0]->transaction_date)); }  ?>
