                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                            ...
                            <div>
                               ...
                               <table id="table" data-toggle="table" data-show-columns="true" data-show-pagination-switch="true"  data-key-events="true" data-show-toggle="true"  data-cookie="true"
    							  ...
    							  <tbody id="tran_table">
                                  <?php $i = 1; $sum_expanse = 0; $sum_purchase = 0; $sum_sell = 0; $sum_profit = 0; foreach(json_decode($list) as $row){ ?>
                                               <tr>

                                                   <td><?php echo $i++; ?></td>
                                                  <td><?php echo date('d-M-Y',strtotime($row->profit_date)); ?></td>
                                                   <td><?php if(isset($row->total_expanse)){ echo $row->total_expanse; } ?> </td>
                                                  
                                                  
                                                  <td><?php if(isset($row->total_purchase)){  echo $row->total_purchase; } ?> </td>
                                                   
                                                   <td><?php  if(isset($row->total_sell)){echo $row->total_sell;  }else{ echo '-';}?> </td>
                                  ...
                                  <tfoot>
                                        <tr>
                                             ...
                                             <td style="border:1px solid #dddddd;"><?php echo +$sum_expanse; ?></td>
                                             <td style="border:1px solid #dddddd;"><i class="fa fa-rupee" style="color:#46c7fe;"></i> <?php echo +$sum_purchase; ?></td>
                                             <td style="border:1px solid #dddddd;"><i class="fa fa-rupee" style="color:#46c7fe;"></i> <?php echo +$sum_sell; ?></td>
