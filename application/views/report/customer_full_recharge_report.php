          ...
          <div class="container-fluid" style="margin-top:15px; ">
           ...
           <div class="col-md-2" style="padding:2px;">
               <div class="product-status-wrap mycard" style=" padding:10px;  border-top:1px solid #0b89de; box-shadow: 0px 3px 8px -1px rgba(0,0,0,0.4); height:120px;">
                <a href="<?php echo base_url(); ?>/report/customer_full_recharge_report/<?php echo $customer_detail[0]->customer_id ; ?>"><button data-toggle="tooltip" title="Recharge Detail"  class="btn btn-primary action_panel_bt active" style="width:100%;">Recharge</button></a> 
                <a href="<?php echo base_url(); ?>/report/customer_full_transaction_report/<?php echo $customer_detail[0]->customer_id ; ?>"><button data-toggle="tooltip" title="Transaction Detail"  class="btn btn-primary action_panel_bt" style=" width:100%;">Transaction</button></a>
               </div>
           </div>
        </div>
        <div class="container-fluid" style="margin-top:15px;">
                ...
                <div class="row">
                   <div class="col-md-12">
						    <div id="myheadtitle" style="margin:0px; height:60px; border-bottom:none; padding-top:15px; font-size: 15.1px;">
                                Customer Recharge report
                                  
                            </div>
                            <div class="asset-inner">
							       
                                <table id="table" class="re_table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true"  data-cookie="true"
									...
									<tr>
									 ...
									 <tbody>
									    <?php $total1 = 0;  $i = 1;  foreach($customer_recharge as $row){ ?>
                                         <tr>
                                             <td><?php echo $i++; ?></td>
                                         ...
                                         <?php $total1 += $row->recharge_amount; ?>
									    <?php } ?>
									</tbody>
                                    <tfoot>
                                        <tr>
                                             <td style="border:1px solid #dddddd; font-weight: 800; color:#46c7fe;">Total</td>
                                             <td></td>
                                             <td style="border:1px solid #dddddd;"><span class="rs_span"><i class="fa fa-rupee"></i> </span> <?php echo number_format($total1); ?></td>
                                             <td></td>
          ...
          <!--   <div class="container-fluid" style="margin-top:115px; ">
            <div class="product-status-wrap mycard" style=" border:1px solid #46c7fe; box-shadow: 0px 3px 8px -1px rgba(0,0,0,0.4); ">
                                                          ...
                                                          <div class="col-md-10" >
                                                            <div class="col-md-3" style="">
                                                              ...
                                                              <div class="col-md-2" style="">
                                                                  <p style="margin:0;"><label>Address 1:</label> <?php echo $customer_detail[0]->address_1; ?></p>
                                                                   <p style="margin:0;"><label>Colony Name:</label> <?php echo $customer_detail[0]->colony_name; ?></p>
                                                                <p style="margin:0;"><label>Balance:</label> <?php echo $customer_detail[0]->balance_amount; ?></p>
                                                              </div>
                                                            <div class="col-md-2">
                                                                
                                                                
                                                                 <p style="margin:0;"><label>Ragistration Date:</label> <?php echo date('d-M-y',strtotime($customer_detail[0]->ragistration_date)); ?></p>
                                                                <p style="margin:0;"><label>Status:</label> <?php echo $customer_detail[0]->card_status; ?></p>
                                                            </div>
                                                            <div class="col-md-5">                                                                
                                                               <a href="<?php echo base_url(); ?>/report/customer_full_recharge_report/<?php echo $customer_detail[0]->customer_id ; ?>"><button data-toggle="tooltip" title="Recharge Detail"  class="btn btn-primary action_panel_bt active" style="width:auto;"><i class="ion-cash" ></i> Recharges</button></a> 
                                                               <a href="<?php echo base_url(); ?>/report/customer_full_transaction_report/<?php echo $customer_detail[0]->customer_id ; ?>"><button data-toggle="tooltip" title="Transaction Detail"  class="btn btn-primary action_panel_bt" style=" width:auto;"><i class="ion-ios-loop" ></i> Transactions</button></a>
                                                              </div>
                                                           </div>
