                                 ...
                                 <div class="form-group data-custon-pick data-custom-mg" id="data_5">
                                     ...
                                     <div class="input-daterange input-group" id="datepicker" style=" width:100%; margin-bottom:0px;">
                                         ...
                                         <div class="col-lg-2 col-md-3 col-sm-2 col-xs-12" >
                                            <div class="form-group" id="data_5" style=" height:28px;">
                                               <input type="text" value="<?php if(isset($return_card_no)){ echo $return_card_no; } ?>" class="form-control" placeholder="*Card No" name="card_no" auto-complete="off"/>
                                            </div>
                                           </div>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true"  data-cookie="true"
								  ...
								  <tbody id="tran_table">
                                     <?php $i = 1; foreach($list as $row){ ?>
                                         <tr class="click_tr" data-bill_id="<?php echo $row->bill_id; ?>" >
                                             <td><?php echo $i++; ?></td>
                                              <td> # <?php echo $row->bill_id; ?></td>
                                             <td><?php echo date('d-M-Y',strtotime($row->bill_date)); ?></td>
                                             
                                              <td><?php if($row->first_name){ echo $row->first_name.' '.$row->last_name; }else{ echo 'Guest'; } ?></td>
                                             <td><?php echo $row->atm_card_no; ?></td>
                                             <td><span class="rs_span"><i class="fa fa-rupee"></i> </span> <?php echo number_format($row->sum_bill_amount,1); ?></td>
                                            
                                             <td><a href="<?php echo base_url(); ?>/billing/print_invoice/<?php echo $row->bill_id; ?>"><button type="button" class="btn"><i class="fa fa-print"></i></button></a></td>
                                        </tr>
                                     <?php } ?>    
								  </tbody>
								</table>
       ...
       $(document).ready(function(){
         ...
         $(document).on('click','.click_tr',function(){
            ...
            var bill_id = $(this).data("bill_id");
               ...
               window.location.href = '<?php echo base_url() ?>report/bill_detail_report/'+bill_id;
