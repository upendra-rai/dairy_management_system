                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    ...
                                                    <form action="<?php echo base_url(); ?>supplyer/add_supplyer" method="post" class="dropzone dropzone-custom needsclick add-professors" id="myForm">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="input-group">
																                                    <span class="input-group-addon"><i class="fa fa-user-o"></i></span>
                                                                    <input name="name" id="name" type="text" class="form-control" value="<?php if(isset($name)){ echo $name; } ?>" placeholder="Name" required>
                                                                </div>
                                                                <div class="input-group">
																                                    <span class="input-group-addon"><i class="ion-social-whatsapp-outline" style="font-size: 18px;"></i></span>
                                                                    <input name="mobile_no" id="mobile_no" type="text" class="form-control" value="<?php if(isset($mobile_no)){ echo $mobile_no; } ?>" placeholder="Mobile No."  minlength="10" onkeydown="validateNumber(event);" required>
                                                                </div>
                                                                <div class="input-group">
																                                    <span class="input-group-addon"><i class="fa fa-envelope-o"></i></span>
                                                                    <input name="email_id" id="email_id" type="email" class="form-control" value="<?php if(isset($email_id)){ echo $email_id; } ?>" placeholder="Email Address" >
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                              <div class="input-group">
                                                                  ...
                                                                  <input name="address" id="address" type="text" class="form-control" value="<?php if(isset($address)){ echo $address; } ?>" placeholder="Address"  required>
                                                              </div>
                                                                <div class="input-group">
																                                    <span class="input-group-addon"><i class="ion-ios-paperplane-outline" style="font-size: 24px;"></i></span>
                                                                    <input name="GST_no"  type="text" class="form-control" value="<?php if(isset($GST_no)){ echo $GST_no; } ?>" placeholder="GST No." autocomplete="new-password" required />
