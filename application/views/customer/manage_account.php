                            ...
                            <div id="myheadtitle" style="margin-bottom:0px; height:45px;">
                                ...
                                Manage Log
                                 ...
                                 <ul class="my_quick_bt" style="width: calc(100% - 150px); right:0;">
                                    ...
                                    <li>
                                          <a href="<?php echo base_url() ?>/manage_account/transaction/<?php if(isset($detail[0]->customer_id)){ echo $detail[0]->customer_id; }  ?>"> <button class="btn btn-primary">Transaction</button></a>
                                            
                                    </li>
                                    <li>
                                         <a href="<?php echo base_url() ?>/manage_account/recharge/<?php if(isset($detail[0]->customer_id)){ echo $detail[0]->customer_id; }  ?>"><button class="btn">Recharge</button></a>
                                    </li>
                                   <!--  <li>
                                                           ...
                                                           <form action="" method="post">
                                                             <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                 ...
                                                                 <div class="col-xs-4">
                                                                <div class="form-group">
                                                                  <input type="number" step="0.01" class="form-control" name="amount" value="" placeholder="Transaction Amount" required>
                                                                </div> 
                                                                 </div>
                                                                 <div class="col-xs-4">
                                                                <div class="form-group">
                                                                 ...
                                                                 <div class="col-xs-4">
                                                                <div class="form-group">
                                                                  <input type="number" step="0.01" class="form-control" name="qty" value="" placeholder="Quantity" required>
                                                                </div> 
                                                                 </div>
                                                                ...
                                                                <div class="form-group">
                                                                  ...
                                                                  <div class="col-xs-3">
                                                                <div class="form-group">
                                                                  <input type="submit" name="submit" value="Add transaction" class="btn btn-primary">
                                                                </div> 
                                                                 </div>
                                                              </div> 
                                                   </form>
                                                                ...
                                                                <div class="asset-inner" >
                                                                 <table  data-toggle="table"   >
					                                 				...
					                                 				<tr>
					                                 		    	  ...
					                                 		    	  <tbody id="tran_table">
                                                                       <?php $i = 1; if(isset($detail_transaction)){ foreach($detail_transaction as $row){ ?>
                                                                              <tr class="product_row" data-product_id="<?php echo $row->product_id; ?>" >
                                                                                  <td><?php echo $i++; ?></td>
                                                                                  
                                                                                  <td> <button name="del_transaction" data-del_id="<?php echo $row->transaction_id; ?>"  class="pd-setting-ed myedit" style="background-color:#e91e63;"><i class="fa fa-trash-o" aria-hidden="true" ></i></button></td>
                                                                                  
                                                                                  
                                                                                  <td><?php echo $row->transaction_date; ?></td>
                                                                                  <td><?php echo $row->atm_card_no; ?></td>
                                                                                  <td> <?php if(isset($row->dairy_product)){ echo $row->dairy_product; }else{ echo $row->e_product; } ?></td>
                                                                                   <td><i class="fa fa-rupee"></i> <?php echo $row->transaction_amount; ?></td>
                                                                                  
                                                                                   <td><i class="fa fa-rupee"></i> <?php echo $row->ledger; ?></td>
...
function validateNumber(evt) {
  ...
  <script type="text/javascript">
     $(document).ready(function(){
          ...
          $(document).on('click','button[name=del_transaction]',function(){
         ...
         $(document).on('click','button[id=del_model_bt]',function(){
			...
			$.ajax({
				 type: 'POST',
				 url: '<?php echo base_url(); ?>manage_account/delete_transaction',
         ...
         $(document).on('change','select[class=chosen-select]',function(){
             ...
             window.location.href = '<?php echo base_url(); ?>/manage_account/transaction/'+customer_id;
         });
