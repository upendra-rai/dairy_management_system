                            ...
                            <div id="myheadtitle" style="margin-bottom:0px; ">
                                ...
                                <ul class="my_quick_bt" style="">
                                    ...
                                    <li>
                                     ...
                                     <li>
                                         <a href="<?php echo base_url() ?>/manage_account/account_balance/<?php if(isset($detail[0]->customer_id)){ echo $detail[0]->customer_id; }  ?>"><button class="btn btn-primary">Current Balance</button></a>
                                    </li>
                                                           ...
                                                           <form action="" method="post">
                                                             <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                  <input type="number" step="0.01" class="form-control" name="amount" value="" placeholder="Set Balance" required>
                                                                </div> 
                                                                 </div>
