                                ...
                                Manage Log
                                 ...
                                 <ul class="my_quick_bt" style="width: calc(100% - 150px); right:0;">
                                   ...
                                   <!--  <li>
                                     ...
                                     <li>
                                         <a href="<?php echo base_url() ?>/manage_account/log_history/<?php if(isset($detail[0]->customer_id)){ echo $detail[0]->customer_id; }  ?>"><button class="btn btn-primary">Log History</button></a>
                                    </li>
                                                                ...
                                                                <div class="asset-inner" >
                                                                 <table  data-toggle="table"   >
					                                 				...
					                                 				<tr>
					                                 		    	  ...
					                                 		    	  <tbody id="tran_table">
                                                                       <?php $i = 1; if(isset($log_history)){ foreach($log_history as $row){ ?>
                                                                              <tr>
                                                                                  <td><?php echo $i++; ?></td>
  ...
  <script type="text/javascript">
     $(document).ready(function(){
         ...
         $(document).on('change','select[class=chosen-select]',function(){
             ...
             window.location.href = '<?php echo base_url(); ?>/manage_account/log_history/'+customer_id;
         });
