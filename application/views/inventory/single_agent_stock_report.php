		...
		<div class="container-fluid" style="margin-top:15px;">
            <div class="product-status-wrap mycard" style="padding-top:0px; border-top:2px solid #0099cc;">
                                     ...
                                     <div class="input-daterange input-group" id="datepicker" style=" width:100%;">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" >
                                          ...
                                          <div class="col-md-2 col-sm-12 col-xs-12" >
                                              ...
                                              <input type="hidden" value="<?php if(isset($return_agent)){ echo $return_agent; } ?>" id="select_agent" />
                                           </div>
				...
				<div class="row">
				 ...
				 <?php }} ?>
                 <?php if(isset($agent_stock_report)){ ?>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        ...
                        <div style="padding-top:10px; font-size: 17px; color:#262d31;">
                            <p>Agent Stock Report / <?php if(isset($return_date)){ echo $return_date; }else{ echo date('d-M-Y'); } ?> / <a class="agent_a" href="" style="color:#262d31;"></a></p>
                            <!--  
						...
						<div class="asset-inner" >
                                ...
                                <table id="table"  data-toggle="table"   data-key-events="true"   data-cookie="true"
									...
									<tr>
							    	  ...
							    	  <tbody id="tran_table">
                                         <?php  $i = 1; foreach($agent_stock_report as $row){ ?>
