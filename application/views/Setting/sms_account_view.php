           ...
           <div class="container-fluid" style="margin-top:15px;">
            <div class="product-status-wrap mycard" style="padding-top:0px; border-top:2px solid #0099cc;">
                ...
                <div style="border: 1px solid grey; padding: 15px;">
                   ...
                   <h4> Credit SMS</h4>
                   <p style="color:#46c7fe; font-weight: 800;" >Total<span style= "float: right;"> <?php echo $sms_details[0]->credit_bal;
                       ?></span></p>
               ...
               <div class="col-md-3"  style=" color:white; padding: 15px;">
                <div style="border: 1px solid grey; padding: 15px;">
                   <h4>Sent SMS</h4>
                   <p style="color:#46c7fe; font-weight: 800;">Total<span style= "float: right;"> <?php echo $sms_details[0]->sended_sms;
                       ?></span></p>
                 </div>
               </div>
               <div class="col-md-3"  style=" color:white; padding: 15px;">
                <div style="border: 1px solid grey; padding: 15px;">
                   <h4>Available SMS</h4>
                   <p style="color:#46c7fe; font-weight: 800;"  >Total<span style= "float: right;"><?php echo  $sms_details[0]->credit_bal -$sms_details[0]->sended_sms; ?></span></p>
                 </div>
               </div>
