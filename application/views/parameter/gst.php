									...
									<tbody>
                                        ...
                                        <tr>                         
														  ...
														  <td style="width:110px; padding:4px; text-align:center;"><?php echo $row->gst_value; ?></td>
                                                           ...
                                                           <td style=" text-align:center;"><a href="<?php echo base_url(); ?>parameter/edit_gst/<?php echo $row->gst_id; ?>"><button class="btn btn-primary" type="button"  data-edit_id="<?php echo $row->gst_id; ?>" style="color:#248afd;  background-color:#f2f2f2; border:1px solid #e2e2e2;"><i class="fa fa-pencil"></i></button></a></td>
										      	          <td style="text-align:center;"><button type="button" class="btn btn-primary" id="confirm_del_action" data-confirm_del_id="<?php echo $row->gst_id; ?>" style="color:#ff4747; background-color:#f2f2f2; border:1px solid #e2e2e2;"><i class="fa  fa-times-circle"></i></button></td>
                          </tr>
										<?php } ?>
									</tbody>
